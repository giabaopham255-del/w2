            ...
            <ul class="ac-gn-list">
                ...
                <li class="ac-gn-item ac-gn-item-menu ac-gn-search" role="search">
                    <a class="ac-gn-link ac-gn-link-search" href="#">
					 <span class="ac-gn-search-placeholder" aria-hidden="true">Search iPhone.com </span></a>
                </li>
            ...
            <div class="row">
                <div class="column large-12 medium-12 small-12">
                    ...
                    <div class="as-banner-content">
                        <div class="pageTitle  ">
                            <h1 class="pageTitle-heading">iPhone Support </h1>
        ...
        <div class="ac-gf-content">
            <section class="ac-gf-footer">
                ...
                <div class="ac-gf-footer-legal">
                    <div class="ac-gf-footer-legal-copyright">Copyright© 2025 iPhone . All rights reserved. </div>
